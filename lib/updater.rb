...
Game.unstored_games.each do |game|
	...
	TeamStat.create(team_id: game.home_team_id, game_id: game.id, winner: game.home_team_score > game.away_team_score, goals: home_team_score, shots: home_shots, blocks: home_stats['hBlock'], pim: home_stats['hPIM'], hits: home_stats['hHits'], fow: home_stats['hFOW'], takeaways: home_stats['hTake'], giveaways: home_stats['hGive'], penalties: home_stats['hPP'])
	...
	TeamStat.create(team_id: game.away_team_id, game_id: game.id, winner: game.away_team_score > game.home_team_score, goals: away_team_score, shots: away_shots, blocks: away_stats['aBlock'], pim: away_stats['aPIM'], hits: away_stats['aHits'], fow: away_stats['aFOW'], takeaways: away_stats['aTake'], giveaways: away_stats['aGive'], penalties: away_stats['aPP'])
